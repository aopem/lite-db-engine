...
namespace litedb
{
    ...
    static std::unordered_map<symbol_e, std::string> symbol_e_map{
        ...
        {symbol_e::KEYWORD_INSERT_INTO, std::string("KEYWORD_INSERT_INTO")},
        {symbol_e::KEYWORD_VALUES, std::string("KEYWORD_VALUES")},
    ...
    static std::unordered_map<std::string, symbol_e> symbol_map{
        ...
        {std::string("INSERT INTO"), symbol_e::KEYWORD_INSERT_INTO},
        {std::string("VALUES"), symbol_e::KEYWORD_VALUES},
